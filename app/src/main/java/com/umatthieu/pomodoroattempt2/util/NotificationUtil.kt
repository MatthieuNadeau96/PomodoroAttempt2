...
import com.umatthieu.pomodoroattempt2.R
import com.umatthieu.pomodoroattempt2.TimerActivity
import com.umatthieu.pomodoroattempt2.TimerNotificationActionReceiver
...
class NotificationUtil {
    companion object {
        private const val CHANNAL_ID_TIMER = "menu_timer"
        ...
        fun showTimerExpired(context: Context){
            ...
            val nBuilder = getBasicNotificationBuilder(context, CHANNAL_ID_TIMER, true)
            ...
            nManager.createNotificationChannel(CHANNAL_ID_TIMER, CHANNEL_NAME_TIMER, true)
